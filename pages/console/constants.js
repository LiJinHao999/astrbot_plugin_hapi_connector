...
const HELP_COMMANDS = [
  ...
  { topic: "approve", usage: "/hapi summary [all|<序号|ID>|status]", summary: "推送忙时托管静默汇总：无参=当前窗口有变更的 session；all=全部；指定序号/ID 推单个；status 查看汇总队列", example: "/hapi summary", home: false },
